...
CREATE UNIQUE INDEX "workspace_invitations_pending" ON "workspace_invitations" USING btree ("workspace_id","email") WHERE accepted_at is null;--> statement-breakpoint
